...
function saludar(nombre="Desconocido", apellido =""){//PARAMETRO POR DEFECTO  // nombre y apellido son parametros, son valores que se le pueden pasar a la función... Los valores digamos no son reales, pues son variables...
